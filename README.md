...
```julia
julia> using Polymer, PolymerArchitecture
```

Documentation is not available yet. However, one can consult the test codes reside in the `test` folder to learn more.
